import csv
import os
from grid_based_clustering.Grid import *
from grid_based_clustering.utils import silhouette_coefficient, clusterMeans
...
def clusterTwoColumns(columnOneIdentifier, columnTwoIdentifier, parsedData, min_den, gridSize):
    ...
    if not os.path.isdir(outputFolder):
        ...
        os.mkdir(evalFolder, 0o755)
        os.mkdir(perClusterFolder, 0o755)
